...
export const Toast: React.FC<ToastProps> = ({
  ...
  return (
    <div
      className={`${typeStyles[type]} border-2 rounded-lg p-4 shadow-lg flex items-center gap-3 min-w-[300px] max-w-md animate-slide-in`}
    >
      <div className="flex-shrink-0 text-white">{icon[type]}</div>
